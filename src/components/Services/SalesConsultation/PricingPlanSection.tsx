...
const PricingSection: React.FC<PricingSectionProps> = ({title,titleTwo ,description, plans }) => {
                        ...
                        <Card key={index} highlighted={plan.highlighted}>
                            ...
                            <div className="mb-8">
                                ...
                                <div className="mt-6">
                                    ...
                                    <span className={`text-sm ml-1 ${plan.highlighted ? 'text-gray-400' : ''}`}>{plan.tax}</span>
                                </div>
                                <div>
                                    <span className={`text-xs ${plan.highlighted ? 'text-gray-400' : ''}`}>{plan.billing}</span>
                                </div>
                                <Button>Book a Call with Specialist</Button>
                            </div>
