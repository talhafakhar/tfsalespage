                        ...
                        <div className="text-center md:text-start">
                            <div className={`transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                                <h1 className="text-5xl sm:text-6xl font-heading font-bold text-white  ">
                                    Transform Your Business Into a <span className="bg-gradient-to-r py-3 from-primary-500 to-primary-400 bg-clip-text text-transparent flex justify-center lg:justify-start">
                                        Revenue-Generating Machine
                                    </span>
                                </h1>
                            </div>
                            <div className={`transform transition-all duration-1000 delay-300 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                                <div className="text-3xl py-3 sm:text-4xl lg:text-5xl font-button font-bold  flex justify-center lg:justify-start items-center space-x-4 bg-gradient-to-r from-primary-500 to-primary-400 bg-clip-text text-transparent">
                            ...
                            <div className={`transform transition-all duration-1000 delay-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                                ...
                                <div className="bg-primary-500 text-black px-2 py-3 rounded-lg inline-block mb-4 animate-pulse-glow">
                                    <p className="font-button text-sm font-semibold">
                                        🔥 We Only Take On 3 New Businesses Per Month
                                    </p>
                                </div>

                                <p className="text-gray-300 mb-7 max-w-xl">
                                    To ensure every client gets deep focus and strategic execution, we limit our new partnerships to just three businesses each month.
                                </p>
                            </div>

                            <div className={`transform transition-all duration-1000 delay-700 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                                <div className="flex flex-col sm:flex-row gap-6 justify-center sm:justify-start  mb-4 items-center">
                            ...
                            <div className={`transform transition-all duration-1000 delay-700 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
                                <div className="text-center justify-center flex gap-2 mb-2">
