...
const FoundersSection = () => {
    ...
    return (
        <section ref={sectionRef} className="bg-black py-10 px-4 relative">
                <div
                ...
                <div className="container mx-auto relative">
                    <div className="flex md:flex-row flex-col items-center  justify-center md:justify-between gap-10 md-gap-1">
                        <div className="flex flex-col gap-4 w-full md:w-1/2">
                            ...
                            >
                              {String(index + 1).padStart(2, '0')}
                                                ...
                                                <div
                                                    className={`flex items-center gap-4 mt-6  font-bold cursor-pointer group transition-all duration-300
                                                       text-primary`}
                                                >
                                                    <span>EXPLORE THIS AREA</span>
                                                    <div
                                                        className={`w-9 h-8 border-2 flex items-center justify-center transition-all duration-300
                                                           border-primary'
                                                        `}
                                                    >
                                                        <ArrowRight
