...
const FoundersSection = () => {
    ...
    return (
        <section ref={sectionRef} className="bg-secondary py-16 px-4 relative">
            <div
            ...
            <div className="max-w-7xl mx-auto relative">
                <div
                    className="flex md:flex-row flex-col items-center  justify-center md:justify-between gap-10 md-gap-1">
                                ...
                                >
                                    ...
                                    >
                                        <div className="flex items-center mb-1">
                                            <div className={`w-14 h-14 border-2 flex items-center justify-center transition-all duration-500 border-primary bg-primary/10`}>
                                                <span className={`text-2xl font-bold transition-all duration-500  text-primary `} >
                              {String(index + 1).padStart(2, '0')}
                            </span>
                                            </div>
                                            <div className={`h-px flex-1 ml-6 transition-all duration-500   bg-primary`}></div>
                                        </div>
                                        <h3 className={`text-2xl font-bold mb-2 transition-all duration-500 text-white`}>
                                            {point.title}
                                        </h3>

                                        <p  className={`leading-relaxed transition-all duration-500 text-white/70`} >
                                            {point.description}
                                        </p>
                                        <div className={`flex items-center gap-4 mt-4  font-bold cursor-pointer group transition-all duration-300 text-primary`} >
                                            <span>EXPLORE THIS AREA</span>
                                            <div className={`w-9 h-8 border-2 flex items-center justify-center transition-all duration-300 border-primary'  `} >
                                                <ArrowRight
                                                    size={16}
