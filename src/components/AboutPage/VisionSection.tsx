            ...
            <div className="mx-auto max-w-6xl relative z-30">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <motion.div
                        ...
                        className="group relative  backdrop-blur-sm p-10 rounded-3xl border border-black shadow-xl"
                    >
                    ...
                    <motion.div
                        ...
                        className="group relative  backdrop-blur-sm p-10 rounded-3xl border border-primary/30 shadow-xl"
                    >
