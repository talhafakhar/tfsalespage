            ...
            <div>
                ...
                <div className="px-6 pb-6 flex items-center justify-between">
                    ...
                    <Link
                        ...
                        <span>Read More</span>
                        <div
                            className="w-8 h-8 bg-yellow-400 rounded-full flex items-center justify-center group-hover/btn:bg-yellow-500 transition-all duration-300 group-hover/btn:scale-110">
                            <ArrowRight size={14}
                                        className="text-black group-hover/btn:translate-x-0.5 transition-transform duration-300"/>
                        </div>
                    </Link>
                </div>
                <div
                    className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300"/>
            </div>
